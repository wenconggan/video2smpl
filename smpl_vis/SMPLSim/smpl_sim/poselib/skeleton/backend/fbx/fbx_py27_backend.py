...
def fbx_to_npy(file_name_in, file_name_out, root_joint_name, fps):
    ...
    times. This script assumes that for mocap model, there is only one animation curve that
    contains all the joints. Otherwise it is unclear how to read in the model.
