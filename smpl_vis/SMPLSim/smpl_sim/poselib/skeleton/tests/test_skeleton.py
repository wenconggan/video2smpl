...
def test_skel_tree():
    skel_tree = SkeletonTree.from_mjcf(
        "/home/serfcx/DL_Animation/rl_mimic/model/skeletons/humanoid_mimic_mod_2_noind.xml",
        backend="pytorch",
    )
...
def test_grad():
    source_motion = SkeletonMotion.from_file(
        "c:\\Users\\bmatusch\\carbmimic\\model\\motions\\JogFlatTerrain_01_ase.npy",
        backend="pytorch",
        device="cuda:0",
    )
    source_tpose = SkeletonState.from_file(
        "c:\\Users\\bmatusch\\carbmimic\\model\\skeletons\\fox_tpose.npy",
        backend="pytorch",
        device="cuda:0",
    )

    target_tpose = SkeletonState.from_file(
        "c:\\Users\\bmatusch\\carbmimic\\model\\skeletons\\flex_tpose.npy",
        backend="pytorch",
        device="cuda:0",
    )
