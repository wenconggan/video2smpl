...
@hydra.main(version_base=None, config_path=str(files('smpl_sim').joinpath('model/cfg')), config_name="config")
def main(cfg : DictConfig) -> None:
    # motions = joblib.load("sample_data/amass_isaac_standing_upright_slim.pkl")
    device = torch.device("cpu")
    motion_file = "model/amass/singles/0-KIT_3_walking_slow08_poses.pkl"
    # motion_file = "model/amass/singles/0-SSM_synced_20160930_50032_punch_kick_sync_poses.pkl"
