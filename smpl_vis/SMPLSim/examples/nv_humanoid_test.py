...
def process_config(args):
    ...
    cfg["model"] = {}
    cfg["model"]["tmp_out_dir"] = osp.abspath("tmp") # please provide an absolute path

    # relative path model: is relative to the root of the nvig_humanoid module
    # you can also specify an absolute path
    cfg["model"]["amass_isaac_gender_betas"] = "sample_data/amass_isaac_gender_betas.pkl"
    cfg["model"]["amass_isaac_gender_betas_unique"] = "sample_data/amass_isaac_gender_betas_unique.pkl"
    cfg["model"]["smpl_template_file"] = "smpl_sim/model/assets/mjcf/humanoid_template_local.xml"
    cfg["model"]["smpl_folder"] = "model/smpl"
...
if __name__ == "__main__":
    ...
    args = get_args()
    args.task = "Humanoid"
    args.cfg_env = osp.join(droot,"smpl_sim/envs/nv/model/cfg/phc_kp_mcp_iccv.yaml")
    args.cfg_train = osp.join(droot,"smpl_sim/envs/nv/model/cfg/train/rlg/im_mcp.yaml")
